        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Manajemen Fakultas</li>
                </ol>
            </nav>
            <h2 class="h4">Manajemen Fakultas</h2>
            <p class="mb-0"></p>
        </div>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="fw-normal">{{ $fakultasItem->slug }}</span></td>
                    <td class="text-end">
                        <a href="#" class="btn btn-info btn-sm btn-rounded" wire:click.prevent="edit({{ $fakultasItem->id }})" data-bs-toggle="modal" data-bs-target="#modaEdit">Edit</a>
                        <a href="#" wire:click.prevent="hapus({{ $fakultasItem->id }})" class="btn btn-danger btn-sm btn-rounded">Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
        </table>
        <div class="mt-2">{{ $fakultas->links() }}</div>
    </div>
    <!-- Modal Content -->
